...
public class FareCalculatorServiceTest {
    ...
    @Test
    @DisplayName("Test for car more than 30 minutes")
    void calculateFareCarWithMoreThan30MinutesParkingTime() {
        Date inTime = new Date();
    ...
    @Test
    @DisplayName("Test for bike more than 30 minutes")
    void calculateFareBikeWithMoreThan30MinutesParkingTime() {
        Date inTime = new Date();
        inTime.setTime(System.currentTimeMillis() - ( 30 * 60 * 1000));
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE, false);
